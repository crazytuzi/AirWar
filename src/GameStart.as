package
{
	...
	{
		/***游戏资源地址数组***/
		private var assetArr : Array = [{ url: "res/atlas/gameRole.atlas" } , { url: "sound/achievement.mp3" , type: Loader.SOUND } , { url: "sound/bullet.mp3" , type: Loader.SOUND } , { url: "sound/game_over.mp3" , type: Loader.SOUND } , { url: "sound/enemy1_die.mp3" , type: Loader.SOUND } , { url: "sound/enemy3_out.mp3" , type: Loader.SOUND }]
		...
		private function onProgress ( loadNum : Number ) : void
		{
			...
			//显示加载进度
			this.txt_load.text = "资源加载中，当前进度：" + ( loadNum * 100 ).toString () + "%";
